package net.spring.kyao233.product_service.service.impl;
...
public class ProductServiceImpl implements ProductService {
    ...
    public List<Product> listProduct() {
        Collection<Product> productColl = daoMap.values();
        List<Product> productList = new ArrayList<>(productColl);
        return productList;
    }
